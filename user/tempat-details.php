...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="index.php#services">Destinasi</a></li>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Destinasi Details</h2>
          <ol>
            <li><a href="index.php">Home</a></li>
            <li><a href="index.php#services">Destinasi</a></li>
            <li>Destinasi Details</li>
          </ol>
        </div>
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          $id = $_GET['kode_id'];
          $sql = "SELECT * 
            FROM tb_tempat where id_tempat = '$id'
            ORDER BY id_tempat";
          $rows_tempat = $db->get_results($sql);

          foreach ($rows_tempat as $row) {
          ?>
            <div class="col-lg-6">
              <?= $row->keterangan; ?>
            </div>
  ...
  <script>
    ...
    var marker = L.marker([tempat[0]['lat'], tempat[0]['lng']]).addTo(map)
      .bindTooltip(`<b>${tempat[0]['nama_tempat']}</b>`).openTooltip();
