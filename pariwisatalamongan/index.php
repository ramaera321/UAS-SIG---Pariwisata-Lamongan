...
<head>
  ...
  <meta name="keywords" content="Kabupaten Lamongan/>
    <meta name=" author" content="unesa.ac.id" />
  <link rel="icon" href="favicon.ico" />
  <link rel="canonical" href="https://unesa.ac.id/" />

  <title>Sistem Informasi Geografis Destinasi Pariwisata di Kabupaten Lamongan</title>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWE_mm7roX5f-A-qEsHAoAONhob2hDf0&language=id&region=ID"></script>
  <script>
...
<body>
  <nav class="navbar navbar-default navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="../desain1/index.html">Kembali</a>
  ...
  <footer class="footer bg-primary">
    <div class="container">
      <p>Copyright &copy; <?= date('Y') ?> unesa.ac.id <em class="pull-right">2021</em></p>
    </div>
  </footer>
</body>
